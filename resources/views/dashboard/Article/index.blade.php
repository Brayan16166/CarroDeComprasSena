...
<div class="container py-4">
    ...
    <br>
    <a href="{{url('dashboard/article/create')}}" class="btn btn-outline-primary">Nuevo articulo</a>
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ url('dashboard/article/'.$article->id.'/edit') }}" class="bi bi-pen"></a></td>
            <td>
