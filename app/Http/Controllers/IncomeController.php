...
class IncomeController extends Controller
{
    ...
    public function create()
    {
        $person = Person::all();
        $user = User::all();
        return view('dashboard.income.create', compact('person', 'user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view("dashboard.income.message", ['msg' => "Ingreso creado con exito"]);
    }
    ...
    public function edit(string $id)
    {
        ...
        $person = Person::all();
        $user = User::all();
        return view('dashboard.income.edit', compact('income', 'person', 'user'));
    }
